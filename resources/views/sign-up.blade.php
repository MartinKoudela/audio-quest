...
<nav class="flex items-center justify-between px-8 py-5 border-b border-white/10 backdrop-blur-md">
    ...
    <a href="/login" class="text-gray-400 text-sm hover:text-white transition-colors">
...
<main class="flex-1 flex items-center justify-center px-4 py-12">
    <div class="relative backdrop-blur-2xl bg-white/10 border border-white/20 rounded-[2.5rem] p-10 w-full max-w-sm shadow-2xl text-center">
        ...
        <h1 class="text-2xl font-semibold text-white tracking-tight mb-2">Create Account</h1>
        <p class="text-gray-300 text-sm mb-8">Join AudioQuest and start your journey.</p>

        @if ($errors->any())
            <div class="mb-6 px-4 py-3 rounded-2xl bg-red-500/20 border border-red-500/50 text-red-200 text-sm text-left">
        ...
        <form method="POST" action="/signup" class="space-y-4">
            ...
            <div class="flex items-center text-xs text-gray-300 gap-2 pl-2">
                <input type="checkbox" required class="accent-[#063C50] h-4 w-4">
        ...
        <p class="text-center text-xs text-gray-400 mt-6">
            Already have an account?
            <a href="/login" class="text-white hover:underline ml-1">Login</a>
        </p>
